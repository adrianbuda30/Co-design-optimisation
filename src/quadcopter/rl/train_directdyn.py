...
from quadcopter_racing_dynamics import QuadcopterEnv
...
def main():
    ...
    while True:
        ...
        env_configs = [{'env_id': i} for i in range(n_envs_train)]
        ...
        n_envs_eval = 1
        env_configs_eval = [{'env_id': i} for i in range(n_envs_eval)]
        ...
        model_name = f"quadcopter_constant_design_dynamics_2"
        ...
        if LOAD_OLD_MODEL is True:
            new_model = []
            old_model = PPO.load(f"/Users/adrianbuda/Downloads/master_thesis-aerofoil/src/quadcopter/trained_model/quadcopter_constant_design_dynamics.zip", env = vec_env)
