...
from rl.sb_quadcopter_env import QuadcopterEnv
import time
...
EVAL_MODEL_PATH = "/home/divij/Documents/quadopter/src/model_dynamics/rl/trained_model/Quadcopter_Schaff_callback_chop_Tanh_Tsteps_245760000_lr_0.0001_hidden_sizes_256_reward_1.00.250.250.00.250.25_varPoleMass_GaussMix_0"
LOOP_COUNT = 10000
    ...
    while True:
        ...
        if EVAL_COUNTER == 1:
            ...
            for i in range(LOOP_COUNT):
                ...
                print(f"reward: {info[0]['reward']:<7.2f} distance: {info[0]['distance']:<7.2f} action: {info[0]['action'][0]:<7.2f} {info[0]['action'][1]:<7.2f} {info[0]['action'][2]:<7.2f} {info[0]['action'][3]:<7.2f} omega: {info[0]['omega_world'][0]:<7.2f} {info[0]['omega_world'][1]:<7.2f} {info[0]['omega_world'][2]:<7.2f}")
