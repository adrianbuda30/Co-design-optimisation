...
def main():
    ...
    while True:
        ...
        log_dir = f"/home/divij/Documents/quadopter/src/model_dynamics/PlanarRobot_tensorboard/TB_{model_name}"
          
        if LOAD_OLD_MODEL is True:
            new_model = []
            old_model = PPO.load("/home/divij/Documents/quadopter/src/model_dynamics/rl/trained_model/random_design/PlanarRobotCircle_length_random_design_start_upd_25lr_mean0.01_std_0.01_sdeFalse_Tanh_Tsteps_256000000_lr_0.0001_hidden_sizes_256_POSreward_0.0_VELreward_1.0_omega_pen_0.2_var_design", env = vec_env)
