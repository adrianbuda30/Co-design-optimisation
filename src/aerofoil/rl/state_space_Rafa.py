...
def state_space(m, x_cg, x_ea, k_h, k_a, k_b):
    ...
    M = np.array([[m_alpha, m_alpha * (x_cg - x_ea) / (c / 2), m_beta * (x_fh - x_h) / (c / 2)], [m_alpha * (x_cg - x_ea) / (c / 2), m_alpha * r_alpha ** 2 / (c ** 2 / 4), m_beta * r_beta ** 2 / (c ** 2 / 4) + m_beta * r * r_beta / (c ** 2 / 4)], [m_beta * (x_fh - x_h) / (c / 2), m_alpha * r_alpha ** 2 / (c ** 2 / 4) - m_alpha * r_alpha * r / (c ** 2 / 4), m_beta * r_beta ** 2 / (c ** 2 / 4) + m_beta * r_beta * r_beta / (c ** 2 / 4) ]])
