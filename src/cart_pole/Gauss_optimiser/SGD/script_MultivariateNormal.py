...
class DesignDistribution_log:
    def __init__(self, initial_mean, initial_cov, lr_mean=0.01, lr_cov=0.01, optimizer_type="adam"):
        ...
        if optimizer_type == "adam":
            ...
            self.optimizer_cov = optim.SGD([self.cov], lr=lr_cov)
        else:
...
design_dist = DesignDistribution_log(initial_mean, initial_cov, optimizer_type=optimizer_choice)
