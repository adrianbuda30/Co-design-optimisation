...
plot(cart_position_simulink-cart_position_openAI, 'r*')
hold on
...
subplot(2, 2, 2)
% Plot the pole_vel_simulink data in red with asterisk markers
plot(cart_vel_simulink-cart_vel_openAI, 'r*')
hold on
...
subplot(2, 2, 3)
% Plot the pole_vel_simulink data in red with asterisk markers
plot(pole_position_simulink-pole_position_openAI, 'r*')
hold on
...
subplot(2, 2, 4)
% Plot the pole_vel_simulink data in red with asterisk markers
plot(pole_vel_simulink-pole_vel_openAI, 'r*')
hold on
